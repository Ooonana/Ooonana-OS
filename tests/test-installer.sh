...
assert_contains "$installer_dry_run" "grub.cfg: linux /boot/vmlinuz root=/dev/vda1 rw console=tty0 console=ttyS0 panic=1 init=/sbin/init ooonana.edition=full-i3 ooonana.smoke=1 ooonana.gui-smoke=1"
