...
grep -qx "linux-firmware" "$ROOT/configs/packages/full-i3.list" &&
  fail "broad linux-firmware metapackage exceeds cloud repo size budget"
...
assert_contains "$branding_contents" "./usr/share/ooonana/wallpapers/ooonana-desktop-0.9.png"
