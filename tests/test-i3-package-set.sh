...
assert_contains "$script_src" "eudev"
...
assert_contains "$script_src" "curl"
assert_contains "$script_src" "wget"
assert_contains "$script_src" "ca-certificates"
assert_contains "$script_src" "python3"
assert_contains "$script_src" "py3-pip"
assert_contains "$script_src" "networkmanager-cli"
assert_contains "$script_src" "networkmanager-tui"
assert_contains "$script_src" "bluez"
assert_contains "$script_src" "iproute2"
assert_contains "$script_src" "util-linux-misc"
assert_contains "$script_src" "pulseaudio-utils"
assert_contains "$script_src" "iw"
assert_contains "$script_src" "wireless-tools"
