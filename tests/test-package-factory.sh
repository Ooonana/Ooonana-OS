...
assert_contains "$gitlab_ci" 'OOONANA_CORE_VERSION: "0.8.26"'
...
assert_contains "$(OOONANA_ROOT="$core_upgrade_root" "$core_upgrade_root/usr/bin/ooonana" version)" "ooonana 0.8.26"
