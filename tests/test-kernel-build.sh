...
assert_contains "$fragment_src" "CONFIG_IKCONFIG=y"
assert_contains "$fragment_src" "CONFIG_IKCONFIG_PROC=y"
assert_contains "$fragment_src" "CONFIG_SWAP=y"
assert_contains "$fragment_src" "CONFIG_ZRAM=y"
assert_contains "$fragment_src" "CONFIG_ZRAM_BACKEND_LZ4=y"
assert_contains "$fragment_src" "CONFIG_ZRAM_DEF_COMP_LZ4=y"
assert_contains "$script_src" "SWAP ZRAM ZRAM_BACKEND_LZ4 ZRAM_DEF_COMP_LZ4"
...
assert_contains "$fragment_src" "CONFIG_FUSE_FS=y"
assert_contains "$fragment_src" "CONFIG_CUSE=y"
...
assert_contains "$fragment_src" "CONFIG_SND_SOC_SOF_HDA_AUDIO_CODEC=y"
assert_contains "$fragment_src" "CONFIG_SND_SOC_INTEL_SKL_HDA_DSP_GENERIC_MACH=y"
assert_contains "$script_src" "SND_SOC_SOF_HDA_AUDIO_CODEC SND_SOC_HDAC_HDA"
assert_contains "$script_src" "SND_SOC_INTEL_SKL_HDA_DSP_GENERIC_MACH"
