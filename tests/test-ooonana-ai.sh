...
assert_contains "$app_gui_dry" "status provider model tools tasks audit history desktop"
assert_contains "$app_gui_dry" "dashboard tabs: home actions ask provider-model logs"
assert_contains "$app_gui_dry" "gui controls: ask form provider/model action launcher"
