...
help="$("$CLI" help)"
assert_contains "$help" "ooonana 0.8.24"
...
assert_contains "$help" "  search - search package names and descriptions"
assert_contains "$help" "  show - show package details"
assert_contains "$help" "  install - install packages"
assert_contains "$help" "  reinstall - reinstall packages"
assert_contains "$help" "  remove - remove packages"
assert_contains "$help" "  purge - remove packages and Ooonana config"
assert_contains "$help" "  update - update list of available packages"
assert_contains "$help" "  upgrade - upgrade installed packages"
assert_contains "$help" "  fix - repair missing or damaged package files"
assert_contains "$help" "  verify - verify installed package files"
assert_contains "$help" "  repo - manage Ooonana package sources and indexes"
assert_contains "$help" "  setup - run first-boot setup"
assert_contains "$help" "  me - show Ooonana logo"
assert_contains "$help" "  wsl - check WSL helper distro"
assert_contains "$help" "  ai - open Ooonana AI commands"
assert_contains "$help" "get/install/add install packages"
assert_contains "$help" "usage/help show this text"
assert_contains "$help" "See 'ooonana help packages'"

sh_help="$(sh "$CLI" help)"
assert_contains "$sh_help" "Usage: ooonana [options] command"
assert_contains "$sh_help" "  me - show Ooonana logo"
...
assert_contains "$ui_help" "ooonana-process-kill"
...
show_ai="$("$CLI" show ai)"
assert_contains "$show_ai" "offline Intel OpenVINO"
assert_contains "$show_ai" "nvidia-nim gemini openvino"
