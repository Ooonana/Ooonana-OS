...
assert_contains "$(<"$rootfs/usr/share/applications/ooonana-ai.desktop")" "Exec=ooonana-ai-app"
assert_contains "$(<"$rootfs/usr/share/applications/ooonana-installer.desktop")" "Exec=ooonana-installer-gui"
assert_contains "$(<"$rootfs/usr/share/applications/ooonana-settings.desktop")" "Exec=ooonana-settings"
