...
assert_contains "$(<"$rootfs/etc/ooonana/sources.d/cloud.repo")" "packages-latest/ooonana-package-repo.tar.gz"
...
assert_contains "$polybar_cfg" "modules-left = brand launcher terminal browser files editor media title"
