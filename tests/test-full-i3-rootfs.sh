...
assert_contains "$polybar_cfg" "modules-left = launcher workspaces title"
assert_contains "$polybar_cfg" "modules-right = wifi bluetooth network audio brightness battery date"
...
assert_contains "$polybar_cfg" "click-left = ooonana-wifi"
assert_contains "$polybar_cfg" "[module/bluetooth]"
assert_contains "$polybar_cfg" "click-left = ooonana-bluetooth"
...
assert_contains "$polybar_cfg" "click-left = ooonana-brightness"
...
assert_contains "$install_wizard" "releases/download/packages-latest/ooonana-package-repo.tar.gz"
