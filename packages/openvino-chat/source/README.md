...
| `tiny` | `HarmenWessels/gemma-4-E2B-it-qat-int4-ov` | `~\.openvino\models\gemma-4-e2b-it-qat-int4-ov` |
...
| --- | --- | --- |
| Gemma 4 E2B / E4B | general/coding | `temperature=1.0`, `top_p=0.95`, `top_k=64` |
...
| Imported Qwen 3.8 9B | general/coding | `temperature=0.6`, `top_p=0.95`, `top_k=20` |
...
Tasks use side panel on wide terminals and one-line next-task strip on narrow ones.
...
generated, and `Esc` cancels without changing compaction state. If runtime still
