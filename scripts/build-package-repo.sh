...
OPENVINO_CHAT_PACKAGE_VERSION="${OOONANA_OPENVINO_CHAT_VERSION:-0.1.7}"
...
CORE_PACKAGE_VERSION="${OOONANA_CORE_VERSION:-0.9.1}"
...
Options:
  ...
  --core-version VER      Ooonana system update package version (default: 0.9.1)
  --openvino-version VER  OpenVINO Chat package version (default: 0.1.7)
