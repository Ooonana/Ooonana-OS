...
REPO_ARGS=()
I3_PACKAGES="xorg-server xinit xf86-video-vesa xf86-video-fbdev xf86-input-libinput xf86-input-evdev eudev i3wm i3status polybar rofi yad picom dunst dmenu feh hsetroot xterm alacritty xsetroot xrandr xinput chromium nemo geany networkmanager network-manager-applet blueman arandr pavucontrol maim mpd mpc ncmpcpp ranger htop vim xsettingsd brightnessctl coreutils parted grub-bios e2fsprogs dosfstools rsync util-linux"
