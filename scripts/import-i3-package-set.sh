...
REPO_ARGS=()
I3_PACKAGES="xorg-server xinit xf86-video-vesa xf86-video-fbdev i3wm i3status dmenu feh xterm xsetroot coreutils parted grub-bios e2fsprogs rsync util-linux"
